...
| Plugin | Purpose |
|--------|---------|
| **@cattoolkit/reason** | Strategic thinking frameworks (first-principles, SWOT, Pareto, 5-whys) |
| **@cattoolkit/guide** | Prompt engineering and design templates |
| **@cattoolkit/execute** | File modifications, project strategy, software engineering protocols |
| **@cattoolkit/verify** | Validation hooks (security, type-checking, protected files) |
| **@cattoolkit/persist** | Session state management and context engineering |
| **@cattoolkit/bootstrap** | System initialization, healing, and plugin management |
