---
name: meta-hooks
description: USE when creating hooks, implementing PreToolUse/PostToolUse/Stop hooks, validating tool use, setting up prompt-based hooks, using ${CLAUDE_PLUGIN_ROOT}, or configuring event-driven automation. Comprehensive hook development guidance for Claude Code plugins.
---
