---
name: meta-mcp
description: USE when integrating databases via MCP, setting up MCP servers, configuring PostgreSQL/MySQL/SQLite connections, or building MCP tool integrations. Comprehensive MCP integration guidance for Claude Code plugins.
---
