---
description: |
  Execute systematic code review protocol using autonomous worker agent for comprehensive analysis and quality assessment.
  <example>
...
- Review git diff for staged changes (for staged reviews)
- Review git diff against HEAD (for PR reviews)
- Identify repository state for code review
...
**Review Checklist:**
- Read the code review protocol from the software-engineering skill
