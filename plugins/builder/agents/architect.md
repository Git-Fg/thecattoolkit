...
1. **Context First**: Use the injected context from the `# Context` section. If no context was injected and DISCOVERY.md exists at `.cattoolkit/planning/{project}/DISCOVERY.md`, read it. DO NOT regenerate discovery.
