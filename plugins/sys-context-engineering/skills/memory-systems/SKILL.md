---
name: memory-systems
description: "MUST USE when designing persistent memory architectures for AI agent systems. Implements progression from Vector RAG → GraphRAG → Temporal Knowledge Graphs, with CrewAI three-tier approach for short-term, long-term, and entity memory."
user-invocable: true
