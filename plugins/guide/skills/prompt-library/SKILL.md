...
name: prompt-library
description: |
  USE when user needs prompt templates, wants to manage prompt chains, or run saved prompts.
  Template library for single prompts, prompt chains (Research/Plan/Do), and meta-prompts.
context: fork
