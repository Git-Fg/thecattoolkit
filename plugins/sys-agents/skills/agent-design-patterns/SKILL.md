...
**Principle:** Delegate tasks to sub-agents with isolated context windows, tools, and instructions.

**Use Cases:**

| Scenario | Pattern |
|:---------|:--------|
| Parallelizable tasks | Map-reduce across sub-agents |
| Long-running tasks | Ralph Loop with persistent files |
| Independent checks | Parallel reviewers |
