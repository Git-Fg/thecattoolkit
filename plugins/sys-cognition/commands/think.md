...
allowed-tools: [Read, Skill(thinking-frameworks), AskUserQuestions]
---
...
3. Select the **most relevant frameworks** from the skill
4. Ask the user **as much as relevant targeted questions with actionable propositions** based on those frameworks to help them uncover hidden assumptions or constraints ; using your native tools
