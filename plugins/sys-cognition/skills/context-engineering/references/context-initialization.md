...
- Scratchpad links to builder's phase plan files in `.cattoolkit/planning/`
...
### With Other Skills
- **manage-planning**: Reference builder's phase plan files in `.cattoolkit/planning/` for current phase
