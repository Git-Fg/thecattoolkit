...
description: "USE when consolidating session state, tracking progress, or preparing for session rotation. Creates detailed session summary with health metrics."
context: fork
agent: scribe
