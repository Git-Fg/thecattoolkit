...
description: "SHOULD USE when designing multi-agent systems for context isolation and parallel execution. Implements Orchestrator, Swarm, and Hierarchical patterns for preventing context saturation."
user-invocable: true
