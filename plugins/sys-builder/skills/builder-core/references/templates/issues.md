...
**MANDATORY:** This file is created when non-critical enhancements are first discovered during execution.

**Location:** `.cattoolkit/planning/{project-slug}/ISSUES.md`
...
- Include suggested phase for roadmap planning

**When resolving issues YOU MUST:**
...
- **MUST** scan ISSUES.md when planning new phases
