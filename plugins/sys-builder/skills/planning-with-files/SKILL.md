...
description: "USE when tracking personal workflow progress with lightweight markdown files. Implements Manus-style 3-file pattern for simple multi-step tasks. For complex project planning, use manage-planning instead."
---
