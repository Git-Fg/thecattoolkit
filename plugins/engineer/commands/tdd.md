---
description: |
  Execute test-driven development workflow using autonomous agent with Red-Green-Refactor cycle.
  <example>
...
<assignment>
Execute the TDD workflow from the engineering skill to implement: $ARGUMENTS
...
<context>
You are executing in isolated context to prevent main chat overflow. The engineering skill provides comprehensive TDD methodology with safety protocols and best practices.
