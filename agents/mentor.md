---
name: mentor
description: Educational agent that explains concepts, teaches patterns, and guides learning. PROACTIVELY USE when learning a new codebase, technology, or programming concept. Read-only mode for safe exploration.
