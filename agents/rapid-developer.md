...
description: Fast-paced development agent for quick iterations. PROACTIVELY USE for prototypes, MVPs, and time-sensitive tasks where speed is prioritized. Full tool access for rapid iteration.
