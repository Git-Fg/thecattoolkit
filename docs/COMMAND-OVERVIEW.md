...
YAML configuration examples for command development. For specifications, see [CLAUDE.md](../CLAUDE.md#part-ii-command-intent-layer).

**Complex Orchestration:** [GOLD_STANDARD_COMMAND.md](GOLD_STANDARD_COMMAND.md)
...
## Development Command with Hook Safety
